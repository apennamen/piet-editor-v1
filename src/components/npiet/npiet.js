...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'npiet.data';
      var REMOTE_PACKAGE_BASE = 'npiet.data';
  ...
  Module['FS_createPath']("/", "assets", true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_npiet.data');

      };
      Module['addRunDependency']('datafile_npiet.data');
   ...
   loadPackage({"files": [{"filename": "/assets/hi.png", "start": 0, "end": 274}], "remote_package_size": 274, "package_uuid": "ee53a0d4-b7a4-4fc0-811f-efdb3290c587"});
